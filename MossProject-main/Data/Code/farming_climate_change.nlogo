...
patches-own [
  ...
  dev-cost ; how expensive placing a farm on this patch is
]
...
<experiments>
  ...
  <experiment name="look-ahead-100-year" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>sum [money] of farm-orgs</metric>
    <metric>sum [farm-agri-output] of farms</metric>
    <metric>farm-coordinates</metric>
    <metric>current-step</metric>
    <enumeratedValueSet variable="max-alt-cost-coeff">
      <value value="2"/>
    ...
    <enumeratedValueSet variable="SLR-rate-0">
      <value value="0.0045"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="look-ahead-blue">
      <value value="80"/>
    ...
    <enumeratedValueSet variable="SLR-rate-1">
      <value value="0.0082"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="time-btw-buy-blue">
      <value value="15"/>
    ...
    <enumeratedValueSet variable="SLR-change-boundary">
      <value value="400"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="profit-threshold-red">
      <value value="0"/>
